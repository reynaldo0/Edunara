...
export default function SiswaFormPage() {
    ...
    // Hanya satu dropdown bisa terbuka
        ...
        <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="bg-[#D9F1FF]/95 rounded-4xl p-10 md:p-14 w-full max-w-4xl flex flex-col items-center gap-10 text-center border border-[#CBE8FF]/60 shadow-2xl relative z-10">
                ...
                <div className="w-full max-w-md relative">
                    <label className="block text-[#003B5C] font-bold text-xl mb-2">Pilih Kursus</label>
                    <button
                        type="button"
                        onClick={() =>
                    ...
                    <ul
                        className={`absolute z-20 mt-1 w-full bg-white border border-none rounded-xl shadow-lg overflow-hidden transition-all duration-300 ${openDropdown === "kursus" ? "max-h-60 py-2" : "max-h-0"
                            }`}
                    >
                ...
                {/* Dropdown Domisili */}
                <div className="w-full max-w-md relative">
                    <label className="block text-[#003B5C] font-bold text-xl mb-2">Domisili</label>
                    <button
                        type="button"
                        onClick={() =>
                    ...
                    >
                        {selectedDomisili || "Pilih domisili..."}
                        <svg
                    ...
                    <ul
                        className={`absolute z-20 mt-1 w-full bg-white border border-none rounded-xl shadow-lg overflow-hidden transition-all duration-300 ${openDropdown === "domisili" ? "max-h-60 py-2" : "max-h-0"
                            }`}
                    >
