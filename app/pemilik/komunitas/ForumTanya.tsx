...
const ForumTanya: React.FC = () => {
    ...
    return (
        <section className="min-h-screen flex flex-col items-center justify-start py-32 bg-[#EAF6FF]">
            <div className="w-full max-w-3xl bg-white/60 backdrop-blur-md rounded-3xl shadow-md border-4 border-pemilik-primary-100 p-6">
                <h2 className="text-center text-2xl md:text-3xl font-bold text-[#003B5C] mb-6">
                    Tanyakan pertanyaanmu disini
                </h2>

                {/* Input pertanyaan */}
                <div className="flex items-center gap-3 bg-white border border-pemilik-primary-100 rounded-full px-4 py-2 shadow-sm mb-3">
                    <input
                        type="text"
                    ...
                    <label className="cursor-pointer text-pemilik-primary-100 hover:opacity-80">
                    ...
                    <button
                        ...
                        className="bg-pemilik-primary-100 hover:bg-[#005F8D] text-white p-2 rounded-full transition"
                    >
                ...
                {previewUrl && (
                    <div className="mb-6">
                        ...
                        <div className="relative w-full max-h-64 aspect-video border border-pemilik-primary-100 rounded-xl overflow-hidden">
                            <Image
                                src={previewUrl}
                                alt="Preview"
                                fill
                    ...
                    {questions.map((q) => (
                        ...
                        >
                            <div className="flex items-center gap-3 mb-3">
                                <HiUserCircle className="text-3xl text-pemilik-primary-100" />
                                <div>
                            ...
                            <div className="flex items-center gap-4 mt-3 text-gray-500 text-sm">
                                <div className="flex items-center gap-1 cursor-pointer hover:text-pemilik-primary-100 transition">
