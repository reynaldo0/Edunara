        ...
        <section className="relative py-20 min-h-screen">
            ...
            <div className="max-w-5xl mx-auto relative z-10">
                ...
                <div className="bg-white shadow-lg rounded-3xl p-6 mb-8 border border-gray-200 transition-transform hover:scale-[1.01] duration-300">
                    <textarea
                        className="w-full border border-gray-200 rounded-xl p-3 focus:ring-2 focus:ring-pemilik-primary-100 outline-none bg-white resize-none"
                        rows={3}
                    ...
                    {posts.map((post) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3 mb-2">
                                <HiUserCircle className="text-4xl text-pemilik-primary-100" />
                            ...
                            {/* List balasan */}
                            <div className="ml-10 mt-4 space-y-4 border-l-2 border-pemilik-primary-100 pl-4">
                            ...
                            {showReplyBox === post.id && (
                                <div className="mt-4 ml-10 transition-all duration-300">
                                    <textarea
                                        className="w-full border rounded-xl p-2 text-sm focus:ring-2 focus:ring-pemilik-primary-100 outline-none bg-white resize-none"
                                        rows={2}
                                    ...
                                    <button
                                        ...
                                        className="mt-2 px-4 py-1 bg-pemilik-primary-100 text-[#003B5C] text-sm rounded-lg hover:bg-[#9AD8F5] transition shadow-md cursor-pointer"
                                    >
                                        Kirim Balasan
                                    </button>
                                </div>
