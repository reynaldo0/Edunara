...
export default function Team() {
        ...
        <section className="min-h-screen flex flex-col items-center justify-center w-full px-6 py-20 relative overflow-hidden pb-60">
            ...
            >
                {teamData.map((member, i) => (
                    <div
                        key={member.id}
                        className={`relative group bg-white/70 backdrop-blur-md rounded-3xl shadow-2xl border border-pemilik-primary-100 p-10 flex flex-col items-center transform transition-all duration-700 ease-out hover:scale-105 hover:shadow-[0_20px_40px_rgba(0,0,0,0.15)]
  ...
  `}
                    ...
                    >
                        ...
                        {/* Foto */}
                        <div className="relative mb-6 w-40 h-44 md:w-48 md:h-52 rounded-2xl overflow-hidden shadow-lg group-hover:shadow-pemilik-primary-100 transition-all duration-500 mt-2 bg-white flex items-center justify-center">
                            <Image
                                src={member.img}
                                alt={member.name}
