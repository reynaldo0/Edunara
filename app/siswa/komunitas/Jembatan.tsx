...
const Jembatan: React.FC = () => {
    return (
        <section className="flex justify-center items-center py-16 px-6">
            <div className="bg-[#AEE3FF] rounded-[32px] p-10 md:p-14 w-full max-w-6xl flex flex-col gap-10 md:gap-14">
                {/* Baris 1: teks kiri, gambar kanan */}
                <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                    <div className="text-[#003B5C] text-lg md:text-xl font-medium leading-relaxed md:w-1/2">
                    ...
                    <div className="bg-white rounded-[16px] shadow-md w-[220px] h-[140px] md:w-[280px] md:h-[180px] flex justify-center items-center">
                        <Image
                            src="/images/umkm-1.svg" // ubah sesuai path gambar kamu
                            alt="Ilustrasi UMKM"
                            width={240}
                            height={160}
                ...
                <div className="flex flex-col md:flex-row-reverse justify-between items-center gap-8">
                    ...
                    <div className="bg-white rounded-[16px] shadow-md w-[220px] h-[140px] md:w-[280px] md:h-[180px] flex justify-center items-center">
                        <Image
                            src="/images/umkm-2.svg" // ubah sesuai path gambar kamu
