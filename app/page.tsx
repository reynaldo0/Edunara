          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 w-[90%] max-w-2xl text-center border border-zinc-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <button
                ...
                className="group flex flex-col items-center justify-center bg-white border-8 border-[#3853A4] hover:border-[#1E2F6E] rounded-2xl p-6 transition-all hover:scale-105 shadow-sm hover:shadow-md"
              >
                <div className="w-24 h-24 mb-4 relative">
                  <Image
